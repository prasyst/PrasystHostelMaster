...
const HouseKeepingTable = () => {
  ...
  const [columns] = useState([
    { id: 'name', label: "Type Name", minWidth: 50 },
    { id: 'shortname', label: 'Abbreviation', minWidth: 50 },
    { id: 'remark', label: 'Remark', minWidth: 50 },
  ]);
    ...
    <div>
      ...
      >
        <Breadcrumbs aria-label="breadcrumb">
          ...
          <Typography color="text.primary">House Keeping Type Master</Typography>
        </Breadcrumbs>
        <Button
          variant="contained"
      ...
      <Paper sx={{ width: '50%', overflow: 'hidden', margin: '0px 0px 0px 50px', border: '1px solid lightgray', marginTop: '30px' }}>
